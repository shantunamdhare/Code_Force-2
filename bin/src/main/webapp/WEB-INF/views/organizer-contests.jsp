...
<head>
    ...
    <title>Manage Contests | CodeForce Pro</title>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .status-live { background: rgba(78, 205, 196, 0.1); color: var(--primary); }
        .status-finished { background: rgba(255,255,255,0.05); color: #94A3B8; }
...
<body>
    ...
    <nav class="sidebar">
        ...
        <div class="nav-group">
            ...
            <a href="${pageContext.request.contextPath}/organizer/contests" class="nav-item active"><i class="ph ph-calendar-star"></i> Contests</a>
            <a href="${pageContext.request.contextPath}/organizer/problems" class="nav-item"><i class="ph ph-brackets-curly"></i> Problems</a>
        </div>
    </nav>
            ...
            <table>
                ...
                <tbody>
                    <c:forEach items="${contests}" var="contest">
                        <tr class="tr-hover">
                            <td style="color:#64748B">#${contest.id}</td>
                            <td>${contest.name}</td>
                            <td>${contest.startTime}</td>
                            <td>${contest.durationSeconds / 60}m</td>
                            <td>
                                <span class="status-badge ${contest.phase == 'LIVE' ? 'status-live' : 'status-finished'}">
                                    ${contest.phase}
                                </span>
                            </td>
                            <td>
